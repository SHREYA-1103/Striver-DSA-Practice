// Given a graph representing the connections between the cities, find the number of provinces where one province is formed by all the cities which are connected together.
