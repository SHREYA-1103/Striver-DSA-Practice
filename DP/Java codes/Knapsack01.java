// -------------------------------- Ques --------------------------------
// Given two arrays with details about n items, val[i] denoting the value of the ith item and wt[i] denoting the weight of the ith item along with the capacity of a bag. Find the maximum valued items that can be kept in the bag such the combined weight of the selected items is less than or equal to the given capacity. Assume that the items can either be selected or not.
// ----------------------------------------------------------------------
